...
const DENTAL_FEATURED: Card[] = [
  ...
  {
    img: "/images/services/cosmetic-1.png",
    label: "Teeth whitening (in-clinic and take-home)",
  },
  {
    img: "/images/services/cosmetic-2.png",
    label: "Porcelain veneers and laminate veneers",
      ...
      <div className="container mx-auto px-[100px] max-[1200px]:px-12 max-[600px]:px-5">
        ...
        <div className="flex items-start justify-between gap-12 mb-10 max-[900px]:flex-col max-[900px]:gap-6">
          ...
          <p className="text-base text-muted leading-relaxed max-w-[520px] max-[900px]:max-w-full">
            ...
            concerns. Whether it&apos;s a regular check-up or a complex surgery,
            we are here for you. With our team of leading dentists in Dubai, we
            are committed to providing you with the best treatment experience
            possible.
          </p>
        </div>
